...
# Once a tap is set up (e.g. Nyantahi/homebrew-tap), users install with:
#   brew tap Nyantahi/tap
...
cask "chibby" do
  ...
  on_intel do
    url "https://github.com/Nyantahi/chibby/releases/download/v#{version}/Chibby_#{version}_x64.dmg"
