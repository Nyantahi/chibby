...
# Once a tap is set up (e.g. okapian/homebrew-tap), users install with:
#   brew tap okapian/tap
...
cask "chibby" do
  ...
  on_arm do
    url "https://github.com/okapian/chibby/releases/download/v#{version}/Chibby_#{version}_aarch64.dmg"
    sha256 "PLACEHOLDER_ARM64_SHA256"
  end

  on_intel do
    url "https://github.com/okapian/chibby/releases/download/v#{version}/Chibby_#{version}_x64.dmg"
    sha256 "PLACEHOLDER_X64_SHA256"
  end

  name "Chibby"
  desc "Local-first CI/CD and deployment tool for solo developers"
  homepage "https://github.com/okapian/chibby"
