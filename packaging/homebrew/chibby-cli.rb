...
class ChibbyCli < Formula
  ...
  on_macos do
    url "https://github.com/chibby-app/chibby/releases/download/v#{version}/chibby-cli-macos-universal.tar.gz"
    sha256 "PLACEHOLDER_MACOS_SHA256"
  end

  on_linux do
    on_intel do
      url "https://github.com/chibby-app/chibby/releases/download/v#{version}/chibby-cli-linux-x86_64.tar.gz"
